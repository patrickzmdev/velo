...
const Success = () => {
  ...
  const { successPage } = statusConfig;
    ...
    <div className="min-h-screen bg-background flex flex-col items-center justify-center p-4">
      ...
      <div className="w-full max-w-2xl bg-card rounded-lg shadow-elegant-lg p-8 animate-scale-in">
        ...
        <div className="flex justify-center mb-6">
          <div className={cn('w-20 h-20 rounded-full flex items-center justify-center', successPage.iconCircleClassName)}>
            <StatusIcon className={cn('w-12 h-12', successPage.iconClassName)} />
          </div>
        </div>
        ...
        <div className="text-center mb-8">
          <h1
            ...
            className={cn('font-display text-3xl font-bold mb-2', successPage.titleClassName)}
          >
            {successPage.title}
          </h1>
          <p className="text-muted-foreground">{successPage.description}</p>
        </div>
